<div class="tm-header">
    ...
    <nav class="uk-navbar">
        ...
        <a class="uk-navbar-brand" href="<?= $view->url()->get() ?>">
            <?php if ($params['logo']) : ?>
                <img class="tm-logo uk-responsive-height uk-hidden-small" src="<?= $this->escape($params['logo']) ?>" alt="<?= $this->escape($params['title']) ?>">
                <img class="tm-logo-small uk-responsive-height uk-visible-small" src="<?= ($params['logo_small']) ? $this->escape($params['logo_small']) : $this->escape($params['logo']) ?>" alt="<?= $this->escape($params['title']) ?>">
            <?php else : ?>
                <?= $params['title'] ?>
            <?php endif ?>
        </a>
